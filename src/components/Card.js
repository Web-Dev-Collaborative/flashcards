          ...
          <div className="grid-parent grid-parent-3">
            <div className="grid-child easy"
              onClick={(e, answer='easy') => {
                ...
                console.dir(this)
                console.dir(answer)
                // TODO Connect to Flashcards.js function for moving cards between decks
                // this is state and should not be managed at the Cards scope
              }}>
